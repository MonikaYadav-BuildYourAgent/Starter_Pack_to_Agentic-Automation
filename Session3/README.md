...
- Collects student details (Name, Email, Query)  
- Uses AI to understand and classify the query into predefined categories  
- Retrieves relevant information from a connected knowledge source using the student’s email  
- Generates accurate and instant responses to student queries  
